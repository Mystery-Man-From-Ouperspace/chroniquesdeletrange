 ...
 * @extends {ActorSheet}
 */
export class CDEMagicPrompt extends ActorSheet {

  /** @inheritdoc */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["chroniquesdeletrange", "sheet", "magic"],
      template: "systems/chroniquesdeletrange/templates/item/magic-dice-prompt.html",
      width: 700,
      height: 600,
      popOut: true,
      title: "Magic",
